...
/*   Updated: 2023/12/12 15:06:05 by rgiraud          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void handle_big_error(t_stack *a, t_stack *b, t_max_value *mv, t_best_moves *bm);
void init_stack_b(t_stack *stack_a, t_stack **stack_b);
void free_stack(t_stack *stack_a, t_stack *stack_b);
int check_sort(t_stack *stack_a);
int check_r_sort(t_stack *stack_a);
void calculate_best_moves(t_stack *a, t_stack *b, t_best_moves *bm, t_max_value *mv);
